...
- [X]  User can filter news by keywords.
...
- [X]  On the details page, user can see the source, author, publish date, image, and description of the article.
    - [X] User can share the article by clicking the share button.
...
- [X] On the Favorite page, user can see a list of articles that they have marked already as favorite.
    - [X] User can click on any item in the favorites list to navigate to the detailed page of the news article.
- [X]  On the Read Later page, user can see a list of articles that they have marked to read later.
    - [X] User can click on any item in the read later list to navigate to the detailed page of the news article.
...
* As a user, I want to filter news by keyword to see only articles that match my interests.
...
* As a user, I want to share a news article with others directly from the app.
...
* As a user, I want my favorite list to persist when I close or reopen the app.
* As a user, I want to tap on a favorite article to navigate to its detailed news page.
...
* As a user, I want my read later list to persist when I close or reopen the app.
* As a user, I want to tap on a favorite article to navigate to its detailed news page.
